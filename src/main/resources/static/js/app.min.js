...
function _init() {
    ...
    $.AdminLTE.layout = {activate: function () {
            ...
            var a = $(".main-footer").outerHeight() || 0, b = $(".main-header").outerHeight() + a, c = $(window).height(), d = $(".sidebar").height() || 0;
...
$(document).ready(function() {
    ...
    $(".add-more").click(function(){ 
          ...
          var answer = $(".copy-fields").html();
          $(".after-add-more").after(answer);
	counter++;
      });
...
function add_question(){
     ...
     divtest.innerHTML = '<div class="form-group"><label for="inputQuestion">Add Question</label><input type="text" class="form-control" id="type-question" placeholder="Type Your Question Here"></div><div><input type="file" onchange="readURL(this);"/></div><div><a href="#" class="preview" onclick="getPreview();">Preview</a><br/> </div><div class="form-group" id="type-option"><label>Select your type option</label><select class="form-control"><option>True False</option><option>Multiple Choice</option></select></div><div> <select class="form-control" id="dropdownlist"><option>Select Option of Question</option><option value="1">1</option><option value="2">2</option><option value="3">3</option> <option value="4">4</option><option value="5">5</option><option value="6">6</option></select><div id="inputArea"></div></div></div></div>';
     objTo.appendChild(divtest);
}

function remove_add_question(rid){
    $('.removeclass'+rid).remove();
}
$("#dropdownlist").change(function () {
  var numInputs = $(this).val();
  for (var i = 0; i < numInputs; i++)
    $("#inputArea").append('<br><input name="inputs[] type="text" class="form-control" />');
